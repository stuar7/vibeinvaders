...
const TopRightHullDisplay = () => {
  ...
  return (
    <div style={{ 
      ...
      fontSize: '14px',
      textAlign: 'right',
      textShadow: '1px 1px 2px rgba(0,0,0,0.8)' // Add text shadow for visibility
    }}>
      ...
      <div style={{ 
        ...
        marginBottom: '8px',
        marginLeft: 'auto' // Right align the bar
      }}>
        <div style={{ 
          width: `${hpPercentage}%`, 
          height: '100%', 
...
export default TopRightHullDisplay;